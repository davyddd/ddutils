...
class TestCreateNewFunction(TestCase):
    def test_new_function_with_same_name(self):
        # Act
        new_func = create_new_function(original_function)
    ...
    def test_new_function_with_new_name(self):
        ...
        # Act
        new_func = create_new_function(original_function, new_name=new_func_name)
    ...
    def test_new_function_preserves_globals(self):
        # Act
        new_func = create_new_function(original_function_retrieved_global_parameter)
    ...
    def test_new_function_preserves_closure(self):
        ...
        # Act
        new_func = create_new_function(original_closure_function)
